...
{{ config(
    ...
    post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(id, state_id, validator_status, pubkey, slashed, withdrawal_credentials), SUBSTRING(id, state_id, validator_status, pubkey, withdrawal_credentials)",
