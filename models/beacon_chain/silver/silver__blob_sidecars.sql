{{ config(
    ...
    post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(blob,kzg_commitment,kzg_proof,body_root,parent_root,state_root,signature),SUBSTRING(blob,kzg_commitment,kzg_proof,body_root,parent_root,state_root,signature)",
    tags = ['beacon']
) }}
