{{ config(
    ...
    post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(block_hash,withdrawal_address,withdrawals_root),SUBSTRING(block_hash,withdrawal_address,withdrawals_root)",
    tags = ['beacon']
) }}
