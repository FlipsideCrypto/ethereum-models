{{ 
  config(
    ...
    tags=['snowflake', 'gold', 'compound', 'compound_redemptions']
  )
}}
...
SELECT  
  DISTINCT block_number,
    ...
    event_inputs:redeemAmount/pow(10,p.token_decimals) AS received_amount,
    event_inputs:redeemAmount*p.token_price/pow(10,p.token_decimals) AS received_amount_usd, 
    CASE WHEN p.token_contract = '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' THEN NULL ELSE p.token_contract END AS received_contract_address,
    CASE WHEN p.token_contract = '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' THEN 'ETH' ELSE p.symbol END AS received_contract_symbol,
