...
prices_hourly AS(
    ...
    FROM
        ...
        LEFT JOIN  {{ ref('core__fact_hourly_token_prices') }} eth_prices
...
flashloan AS(
    SELECT
        ...
        COALESCE(event_inputs:initiator::string, origin_from_address) AS initiator_address,
...
FROM
    ...
    LEFT OUTER JOIN
    {{ ref('core__dim_labels') }} l ON LOWER(underlying.aave_token) = l.address AND l.creator = 'flipside'
