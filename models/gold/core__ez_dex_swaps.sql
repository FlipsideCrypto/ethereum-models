...
SELECT 
  ...
  swp.contract_address,
  swp.event_name,
  swp.amountIn / power(10, d0.decimals) AS amountIn,
  swp.amountOut / power(10, d1.decimals) AS amountOut,
  swp.amountIn * price0.price / power(10, d0.decimals) AS amountIn_usd,
  swp.amountOut * price1.price / power(10, d1.decimals) AS amountOut_usd,
  swp.token0_address,
  swp.token1_address,
