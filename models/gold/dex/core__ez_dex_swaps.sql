...
univ3_swaps AS (
  SELECT
    ...
    'Swap' AS event_name,
    CASE  -- draft
      WHEN platform = 'uniswap-v3' AND amount0_unadj > 0 THEN ABS(amount0_adjusted)
      WHEN platform = 'uniswap-v3' AND amount0_unadj <= 0 THEN ABS(amount1_adjusted)
      ELSE amount_in 
    END AS amount_in,
    CASE
