...
SELECT
    ...
    decoded_flat :"destination" :: STRING AS destination,
    decoded_flat :"lockId" :: INTEGER AS lockId,
    decoded_flat :"recipient" :: STRING AS recipient,
    decoded_flat :"sender" :: STRING AS sender,
    decoded_flat :"tokenSource" :: STRING AS tokenSource,
    decoded_flat :"tokenSourceAddress" :: STRING AS tokenSourceAddress,
    decoded_flat,
    event_removed,
    tx_status,
    _log_id,
