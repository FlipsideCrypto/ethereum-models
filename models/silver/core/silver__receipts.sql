...
{{ config(
    ...
    post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(block_hash, tx_hash, from_address, to_address, tx_success, position), SUBSTRING(block_hash, tx_hash, from_address, to_address, tx_success)",
    full_refresh = false,
    tags = ['realtime']
) }}
