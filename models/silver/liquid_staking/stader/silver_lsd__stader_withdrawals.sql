...
WITH final_withdrawals AS (
    ...
    SELECT
        ...
        tx_hash,
        event_index,
        'FinalizedWithdrawRequest' AS event_name,
        contract_address,
    ...
    FROM
        {{ ref('silver__logs') }}
    WHERE
        topics [0] :: STRING = '0x12a00f5e4c3614409f2dd90dc5be91b9b64ef89bac58a5b034ec0094376dbd37' --FinalizedWithdrawRequest
...
FROM
    ...
    ON w.requestId = r.requestId qualify (ROW_NUMBER() over (PARTITION BY w._log_id
ORDER BY
