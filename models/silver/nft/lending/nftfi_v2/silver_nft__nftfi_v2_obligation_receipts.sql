...
SELECT
    ...
    utils.udf_hex_to_int(
        decoded_input_data :_data :: STRING
    ) :: STRING AS loanid,
    decoded_input_data :_to :: STRING AS mint_to_address,
    to_address AS obligation_receipt_address,
    decoded_input_data :_tokenId :: STRING AS tokenid,
