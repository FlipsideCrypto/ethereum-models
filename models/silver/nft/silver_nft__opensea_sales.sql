...
WITH opensea_sales AS (
    ...
    SELECT
        ...
        _inserted_timestmap :: TIMESTAMP AS _inserted_timestmap,
        ROW_NUMBER() over(
...
direct_interactions AS (
    SELECT
        ...
        opensea_sales._inserted_timestmap AS _inserted_timestmap,
...
indirect_interactions AS (
    SELECT
        ...
        tx_data._inserted_timestmap AS _inserted_timestmap,
        nft_transfers.from_address AS nft_from_address,
        nft_transfers.to_address AS nft_to_address,
...
ORDER BY
    _inserted_timestmap DESC, currency_symbol)) = 1
