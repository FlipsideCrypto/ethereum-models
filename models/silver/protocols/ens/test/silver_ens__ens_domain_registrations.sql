...
new_resolver AS (
    ...
    FROM
        base_events
    WHERE
        topic_0 = '0x335721b01866dc23fbee8b6b2c7b1e14d6f05c28cd35a2c934239f94095602a0' qualify (ROW_NUMBER() over (PARTITION BY _log_id
    ORDER BY
...
SELECT
    ...
    r.contract_address,
    r.origin_from_address AS manager,
    owner,
    NAME,
    label,
    node,
